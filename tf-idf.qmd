...
# Data 
# These Rdata files were creates in "fynn-scratch.R"
...
#plotting the word analysis tf-idf for the top 10 frequent words from each college
# Using top_word_tfidf that has a word column with single words found in the college's 
# subreddits and their corresponding tf-idf values
top_word_tfidf |>
...
# top_bigram_tfidf has a bigram column with the two-word phrases from each subreddit and their 
# corresponding tf-idf values
 top_bigram_tfidf |>
