...
Nevertheless, are these results conclusive? We recommend you head over to our [Kruskal-Wallis Test results](Sentiment-analysis.qmd#tbl-kw-results) to see if these differences are significant.
...
#| fig-cap: "Time series graph displaying the quarterly keyword avg per post by subreddit" 
