---
title: "(some catchy title): An Analysis of All Posts in the Amherst College, Williams College, and Middlebury College Subreddits (2020-2025) or Exploring the Emotional Patterns of College Life Through Reddit"
subtitle: "Using methods of sentiment analysis, or Analyzing Student Sentiment in the Reddit Communities of Amherst, Williams, and Middlebury from 2020 to 2025"
author: 
- "Fynn Hayton-Ruffner"
- "Shekinah Ninziza"
- "Kinglee Tham"
...
If you are unfamiliar with [Reddit.com](https://www.reddit.com/), we may have to begin by inquiring about the rock you've been living under for nigh-on two decades. In all seriousness (don't stop reading we're sorry), along with X, the forum-based social media platform is a primary hub for raw, unadulterated commentary on any issue one you could think of (for better or for worse). It is this plethora of unfiltered content that makes Reddit a commonly visited site for web scrapers and data scientist nerds alike with a variety of goals including but not limited to: theme and topic discovery, sentiment and engagement analysis, and user activity research. Our current data science project is spurred by similar motivations, as we look to extract key topics and conduct sentiment analysis (positive or negative valence of a text) for three individual subreddits: [Amherst College](https://www.reddit.com/r/amherstcollege/), [Williams College](https://www.reddit.com/r/WilliamsCollege/), and [Middlebury College](https://www.reddit.com/r/middlebury/). Specifically, we aim to meaningfully compare the sentiments (again how positive and negative they are) of each subreddit, as both a per-post average and a totality, examine temporal trends in sentiment and comment engagement, extract the most frequently discussed topics, and, because we are looking at colleges here, track mentions of the admissions process.

Now, you may be wondering why these specific subreddits, and what this project can tell us in the grand scheme of things. As students at Amherst College, we thought it would be particularly fun to compare our own subreddit to some of our least favorite sister schools in the NESCAC. The three subreddits were also founded around similar times, and were young enough for us to be able to scrape their entire contents with no issue. In regards to our purpose, even if you are not a current student in the NESCAC who may get a kick out of pitting Amherst, Middlebury, and Williams against each other, our analysis proves insights into what is being discussed and priortized at these different institutions, along with an assessment of their varying levels of positivity. We think of prospective students as one group who might be particularly interested in our results, as well as anyone curious about the state of the small liberal arts colleges (at least from Reddit's perspective). With that out of the way, lets talk about how we got the data. 

# RedditExtractoR

Web scraping is a notoriously error-laden path, as websites increasingly deploy dynamically rendered data and IP-Address blocking it has never been harder to get the data you want. Luckily, we found a tool that was able to scrape every single post that has ever been made to each of our subreddits of interest. The @rivera_ivan RedditExtractoR scraping package gives you a post's content, title, number of comments, and date, all in as little as 3 lines of R code:
