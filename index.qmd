...
abstract: |
  ...
  How does sentiment flow through the online communities of college students?
  In this project, we dive into the world of Reddit, analyzing the emotional tone of posts across three college subreddits —     Amherst, Williams, and Middlebury. By obtaining data from real-time scraping using the RedditExtractoR package, we measure     sentiment over time to see if any particular time, such as the college admissions season or controversies on campus, triggers   sentiment shift. Through text analysis and statistical modeling, we aim to study how the words of students manifest the        sentiment spectrum of their communities in transition and how sentiment translates to engagement levels like comment activity   and the popularity of a post
